...
|                              | US-4    | Admin Purchase        | menerima notifikasi ketika ada request baru atau ada *follow-up*                                                    | saya bisa segera memprosesnya.                                                        | **Tinggi**  |
...
| :-------- | :------------------------------------ | :---------------------------------------------- | :---------------------------------- | :------------------- |
| **BR-001**| Persetujuan Request                   | `status == 'PENDING'`                           | Melakukan Persetujuan Awal          | `Admin Purchase`, `Super Admin` |
