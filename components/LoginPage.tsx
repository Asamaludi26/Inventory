...
// Component for the Demo Accounts Modal
const DemoAccounts: React.FC = () => {
    ...
    const demoUsers = [
        ...
        { role: 'Staff', email: 'budi.wijaya0@triniti.com', password: 'password123' },
    ];
        ...
        <>
            ...
            >
                <div className="space-y-4 text-sm text-gray-700">
                    ...
                    <p>
                        Masa uji coba untuk versi demo ini akan berakhir dalam <strong>7 hari</strong>, yaitu pada tanggal <strong>{formattedEndDate}</strong>. Setelah tanggal tersebut, akses akan ditutup.
                    </p>
