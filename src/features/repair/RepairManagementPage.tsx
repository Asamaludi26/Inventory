...
const RepairManagementPage: React.FC<RepairManagementPageProps> = ({ assets, users, onShowPreview, onStartRepair, onAddProgressUpdate, onReceiveFromRepair, onCompleteRepair, onDecommission }) => {
