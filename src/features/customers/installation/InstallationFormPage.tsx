...
const InstallationFormPage: React.FC<InstallationFormPageProps> = ({ setActivePage }) => {
    return (
        <div className="flex items-center justify-center h-[calc(100vh-8rem)] p-8 text-center bg-gray-50">
            <div>
                ...
                <h1 className="mt-4 text-2xl font-bold text-gray-800">Formulir Instalasi Pelanggan</h1>
