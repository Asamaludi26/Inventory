...
interface ManageAccountPageProps {
    currentUser: User;
    onSave: (data: { name: string; email: string; currentPassword?: string; newPassword?: string }) => Promise<boolean>;
    onBack: () => void;
}
...
const ManageAccountPage: React.FC<ManageAccountPageProps> = ({ currentUser, onSave, onBack }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        const success = await onSave({ name, email, currentPassword, newPassword });
        setIsLoading(false);
