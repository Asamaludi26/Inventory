...
import { User, Division, Page, Asset } from '../../types';
...
const DivisionDetailPage: React.FC<DivisionDetailPageProps> = ({ division, members, assets, onBack, onEdit, onViewMember }) => {
    const totalAssetsInDivision = assets.filter(asset => members.some(member => member.name === asset.currentUser)).length;
