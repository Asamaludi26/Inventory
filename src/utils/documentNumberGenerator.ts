/**
 * Menghasilkan nomor dokumen yang unik untuk tanggal tertentu dengan format PREFIX-YYMMDD-XXX.
 * Fungsi ini memeriksa dokumen yang ada untuk tanggal tersebut dengan prefix yang sama
 * dan menghasilkan nomor urut berikutnya.
 * 
 * @param prefix Prefix untuk nomor dokumen (misal: 'HO', 'DSM').
